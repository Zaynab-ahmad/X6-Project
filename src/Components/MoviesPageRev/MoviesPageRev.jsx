  ...
  const reviewsData = [
    {
      ...
      numbervalue: "4.5",
      paragraph:
        "This movie was recommended to me by a very dear friend who went for the movie by herself. I went to the cinemas to watch but had a houseful board so couldnt watch it.",
      rating: true,
    },
    {
      from: "From India",
