  ...
  const cards4Data = [
    {
      length: "1h 57min",
      rating: fourAndHalf,
      source: mustWatchMoviesimages[0].src,
      id: mustWatchMoviesimages[0].id,
    },
    {
      length: "1h 30min",
      rating: fourStars,
      source: mustWatchMoviesimages[1].src,
      id: mustWatchMoviesimages[1].id,
    },
    {
      length: "1h 42min",
      rating: fourAndHalf,
      source: mustWatchMoviesimages[2].src,
      id: mustWatchMoviesimages[2].id,
    },
    {
      length: "2h 10min",
      rating: fourStars,
      source: mustWatchMoviesimages[3].src,
      id: mustWatchMoviesimages[3].id,
    },
  ];
  ...
  return (
    <div>
      <HomeMoviesAndShowsTitle
        title={`Must-Watch ${text ?? defaultText} Movies`}
        home={false}
        fontSizeType="type3"
